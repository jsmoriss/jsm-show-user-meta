...
<p><strong>The current user needs to have the WordPress 'manage_options' capability to view the User Metadata metabox, and the 'manage_options' capability to delete individual meta keys.</strong> The default 'manage_options' capability can be modified using the 'jsmsum_show_metabox_capability' and 'jsmsum_delete_meta_capability' filters (see filters.txt in the plugin folder).</p>
